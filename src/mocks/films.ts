...
const films: FilmInfo[] = [
  ...
  },
  {
    ...
    description:
      'A year after their fathers funeral, three brothers travel across India by train in an attempt to bond with each other.',
    rating: 3.6,
    scoresCount: 165106,
  ...
  },
  {
    ...
    description:
      'A look into the daily (or rather, nightly) lives of three vampires whove lived together for over 100 years, in Staten Island.',
    rating: 7.2,
    scoresCount: 6173,
  ...
  },
  {
    ...
    description:
      'True story of Heinrich Harrer, an Austrian mountain climber who became friends with the Dalai Lama at the time of Chinas takeover of Tibet.',
    rating: 3.6,
    scoresCount: 112612,
